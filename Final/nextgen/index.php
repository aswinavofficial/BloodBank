			...
			<div class="container">
				<div class="banner_top">
					<div class="col-md-6 col-sm-4 col-xs-4 logo">
						<h1><a href="index.html">Charity<span>Platform</span></a></h1>
					</div>
				...
				<div class="col-md-7 callbacks_container">
					<ul class="rslides" id="slider3">
						...
						<li>
							<div class="slider-info">
								 <h3>Opening Minds, Changing Lives.</h3>
					...
					<div class="modal-body login-page "><!-- login-page -->     
						<div class="login-top sign-top">
							...
							<form action="login.php" method="post">
								<input type="email" class="email" id="email_id" placeholder="Enter email" name="email_id"  required=""/>
								<input type="password" class="password" id="password" placeholder="Enter password" name="password"  required=""/>
						...
						<div class="login-top sign-top">
							...
							<form action="reg.php" method="post">
								...
								<input type="password" name="password2" id="password2"  placeholder="Confirm Password" required="">
                                                              Type: &nbsp;&nbsp;
                                                              <input type="radio" name="type" value="D"> Donor
                                                             <input type="radio" name="type" value="V" > Vendor
                                                             <input type="radio" name="type" value="S" > Seeker
								<div class="wthree-text"> 
									<ul> 
										<li>
											<label class="anim">
	...
	<div class="col-md-6 about-grids-w3l">
		<div class="about-first-w3">
			<div class="col-md-4 col-sm-4 col-xs-4 welcome-img">
				<img src="images/1.png" class="img-responsive zoom-img" alt=""/>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-4 welcome-img">
				<img src="images/2.jpg" class="img-responsive zoom-img" alt=""/>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-4 welcome-img">
				<img src="images/3.png" class="img-responsive zoom-img" alt=""/>
			</div>
			<div class="clearfix"> </div>
		</div>
		<div class="about-first-w3">
			<div class="col-md-4 col-sm-4 col-xs-4 welcome-img">
				<img src="images/4.png" class="img-responsive zoom-img" alt=""/>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-4 welcome-img">
				<img src="images/5.png" class="img-responsive zoom-img" alt=""/>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-4 welcome-img">
				<img src="images/6.png" class="img-responsive zoom-img" alt=""/>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
	<div class="col-md-6 w3layouts_event_right">
		<h3>Safe Place Where Healing Begins</h3>
		<div class="slider">
					...
					<li>
						<div class="w3_event_right_grid">
							<div class="w3layouts_event_right_para">
								<p>Be a part of the breakthrough and make someone’s dream come true. 
									</p>
							</div>
						</div>
					</li>
