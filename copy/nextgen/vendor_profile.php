                            ...
                            <tbody id="items">
                              ...
                              if( $no2==0 ){
                                 ...
                                 while( $row = mysqli_fetch_assoc( $his ) ){
                                  echo " <tr><td >{$row['trans_id']}</td><td >{$row['req_id']}</td ><td>{$row['org_name']}</td> <td>{$row['org_name']}</td><td >{$row['location']}</td> <td >{$row['type']}</td> <td >{$row['ser_type']}</td> <td >{$row['open_date']}</td> <td >{$row['status']}</td></tr>\n";
                                    }
                                     }
                                      ?> 
                            </tbody>
